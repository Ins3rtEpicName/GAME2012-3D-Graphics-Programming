...
void display(void)
{
	...
	// Cone.
	transformObject(glm::vec3(1.0f, 1.0f, 1.0f), X_AXIS, 0.0f, glm::vec3(3.0f, 0.0f, 0.0f));
	g_cone.RecolorShape(1.0f, 0.5f, 0.0f);
	g_cone.DrawShape(GL_LINE_STRIP);

	// Plane.
	transformObject(glm::vec3(2.0f, 1.0f, 1.0f), X_AXIS, 0.0f, glm::vec3(5.0f, 1.0f, -5.0f));
	g_plane.RecolorShape(1.0f, 0.0f, 0.0f);
	g_plane.DrawShape(GL_TRIANGLES);
...
int main(int argc, char** argv)
{
	...
	glutCreateWindow("Week 10 - 01_ShapeGenerator");
