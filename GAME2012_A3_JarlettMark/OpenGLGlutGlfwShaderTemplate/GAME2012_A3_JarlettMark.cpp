...
//
// Description:
// Assignment 3 for GAME2012 - 3D Graphics Programming.
// Two rotating cubes with dice textures placed 6 units apart on the x-axis.
// Using Professor Hooman Salamat's Template from week 10 or 11. (I lost track of which week it is)
//***************************************************************************
...
moveSpeed = 0.1f,
turnSpeed = 1.0f;
float rotAngle1, rotAngle2 = 0.0f;
...
GLfloat cube_vertices[] = {
	-0.9f, -0.9f, 0.9f,		0.75f, 0.33f,	// 0.
	0.9f, -0.9f, 0.9f,		0.5f, 0.33f,	// 1.
	0.9f, 0.9f, 0.9f,		0.5f, 0.66f,	// 2.
	-0.9f, 0.9f, 0.9f,		0.75f, 0.66f, 	// 3.
	-0.9f, -0.9f, -0.9f,	0.0f, 0.33f,	// 4.
	0.9f, -0.9f, -0.9f,		0.25f, 0.33f,	// 5.
	0.9f, 0.9f, -0.9f,		0.25f, 0.66f, 	// 6.
	-0.9f, 0.9f, -0.9f,		0.0f, 0.66f,	// 7.

	-0.9f, -0.9f, -0.9f,	0.75f, 0.0f,	// 4b. 8
	0.9f, -0.9f, -0.9f,		0.5f, 0.0f,		// 5b. 9
	-0.9f, 0.9f, -0.9f,		0.75f, 1.0f,	// 7b. 10
	0.9f, 0.9f, -0.9f,		0.5f, 1.0f,		// 6b. 11
	-0.9f, -0.9f, -0.9f,	1.0f, 0.33f,	// 4c. 12
	-0.9f, 0.9f, -0.9f,		1.0f, 0.66f		// 7c. 13
};
...
void loadTexture()
{
	...
	unsigned char* image = stbi_load("A3_DieImage.png", &width, &height, &bitDepth, 0);
	if (!image) {
		cout << "Unable to load file!" << endl;
		// Could add a return too if you modify init.
	}

	glGenTextures(1, &A3_diceTextureID);
	glActiveTexture(GL_TEXTURE0);
	glBindTexture(GL_TEXTURE_2D, A3_diceTextureID);
...
void display(void)
{
	...
	// Cube 1
	transformObject(0.3f, XY_AXIS, rotAngle1 += 5, glm::vec3(-3.0f, 0.0f, 0.0f));
	glDrawElements(GL_TRIANGLES, 36, GL_UNSIGNED_SHORT, 0);

	// Cube 2
	transformObject(0.3f, XY_AXIS, rotAngle2 -= 5, glm::vec3(3.0f, 0.0f, 0.0f));
	glDrawElements(GL_TRIANGLES, 36, GL_UNSIGNED_SHORT, 0);
...
void clean()
{
	...
	glDeleteTextures(1, &A3_diceTextureID);
}
